function [log] = joyVehicle(varargin)
    ...
    try
        ...
        while(vehicleObject.activated)
            ...
            for i = 1:length(messagesTypeOut)
                messagesOut = [messagesOut; encodeSerial(messagesTypeOut(i),messagesDataOut{i})];
            end
        ...
        fwrite(serialHandle, encodeSerial(eStopMessageType,eStopMessageData));
    catch mainErr
        try
